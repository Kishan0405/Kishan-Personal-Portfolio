    ...
    <div class="w-full max-w-md animate-slide-in-fade">
        <div class="glassmorphic-bg rounded-2xl p-8 shadow-2xl">
            <header class="text-center mb-8">
                <h1 class="text-3xl font-bold gradient-text tracking-tight">Welcome Back!</h1>
                <p class="text-base text-[var(--text-light)] mt-2">Log in with your QuizzletMaster account.</p>
            </header>
            ...
            <form action="" method="POST" class="space-y-6">
                <div>
                    <label for="username_or_email" class="block text-sm font-medium text-[var(--text-light)] mb-2">Username or Email</label>
                    <div class="relative">
                        <span class="absolute inset-y-0 left-0 flex items-center pl-3">
                            <i class="fas fa-user text-[var(--text-light)]"></i>
                        </span>
                        <input type="text" id="username_or_email" name="username_or_email"
                            class="w-full bg-[var(--card-bg)] border border-[var(--border)] text-[var(--text-dark)] rounded-lg py-3 pl-10 pr-4 focus:outline-none focus:ring-0 focus:border-[var(--primary-blue)] transition"
                ...
                <div>
                    <div class="flex items-center justify-between">
                        <label for="password" class="block text-sm font-medium text-[var(--text-light)]">Password</label>
                        <a href="forgotpassword.php" class="text-sm text-[var(--primary-blue)] hover:underline">Forgot Password?</a>
                    </div>
                    <div class="relative mt-2">
                        <span class="absolute inset-y-0 left-0 flex items-center pl-3">
                            <i class="fas fa-lock text-[var(--text-light)]"></i>
                        </span>
            ...
            <p class="text-center text-sm text-[var(--text-light)] mt-8">
                Don't have an account?
                <a href="register.php" class="font-medium text-[var(--primary-blue)] hover:underline">Sign up</a>
            </p>
        </div>
    </div>
</main>
