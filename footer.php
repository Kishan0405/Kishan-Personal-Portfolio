...
<style>
    ...
    .lang-option.selected {
        background-color: rgba(0, 123, 255, 0.1); /* Accent low opacity */
        color: var(--accent);
        font-weight: 600;
    }

    /* Hide the Actual Google Element completely from view, but keep in DOM */
    ...
    /* ==========================================================================
       CRITICAL: FORCE HIDE GOOGLE TOP BANNER & TOOLTIPS
       ========================================================================== */
...
<footer class="bg-[var(--bg-secondary)] border-t border-[var(--border)] pt-12 pb-8 lg:ml-60">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            options.forEach(option => {
                option.addEventListener('click', () => {
                    ...
                    const langName = option.innerText.split(' ')[0]; // Get just the name
        ...
        function triggerGoogleTranslate(langCode) {
            // Find the Google Combo box (it's hidden but exists)
